...
(63, 16, 'wp_all', 'View all staffs performance', 0),
(64, 16, 'wp_other', 'View others permission', 0),
(65, 11, 'pms_notification', 'Can access notification wizard', 0);
...
(16, 'Work Performance', 'http://127.0.0.1/performance', 'wp', 'Depend on swassertive.', 0);
...
(38, 35, 1576304549, 0, 'Software engineer');
...
(79, 2, 14, '[{\"keyword\":\"CRUD\",\"val\":true}]'),
(80, 2, 16, '[{\"keyword\":\"wp_all\",\"val\":true},{\"keyword\":\"wp_other\",\"val\":true}]'),
(81, 2, 11, '[{\"keyword\":\"pms_read\",\"val\":true},{\"keyword\":\"pms_update\",\"val\":true},{\"keyword\":\"pms_delete\",\"val\":true},{\"keyword\":\"pms_generate_csv\",\"val\":true},{\"keyword\":\"pms_price_log\",\"val\":true},{\"keyword\":\"pms_quantity_log\",\"val\":true},{\"keyword\":\"pms_stock_out\",\"val\":true},{\"keyword\":\"pms_stock_in\",\"val\":true},{\"keyword\":\"pms_create\",\"val\":true},{\"keyword\":\"pms_import_csv\",\"val\":true},{\"keyword\":\"pms_notification\",\"val\":true}]');
...
(35, 'Tomal Hasan', 1576304549, 'tomal', '81dc9bdb52d04dc20036dbd8313ed055', 'Male', 'Islam', 'A+', 'Dhaka-1205', 1576304591, 2, 0, '[]');
...
--
ALTER TABLE `dgn`
  MODIFY `dgnId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `permission`
  MODIFY `permissionId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
